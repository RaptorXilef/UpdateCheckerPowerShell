function CheckIfUpdateIsAvailable {
    param (
        [string]$currentVersion = "VERSIONS-NUMBER", # <----------- VERSION Examlpes: 0.0.1   0.0.1-alpha   0.0.1-beta   0.0.1-rc    0.0.1-release_candidate    0.0.1-stabile    0.0.1-stabile_version
        [string]$repoOwner = "GitHub-Name", # <----------- GitHub-Name Examlpe: RaptorXilef
        [string]$repoName = "repository-Name" # <----------- repository-Name Examlpe: UpdateCheckerPowerShell
    )
